...
const PracticeGameV2: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center p-4 bg-gray-900 min-h-screen text-white">
      ...
      {!gameOver && !gameWon && <MobileTouchControls gameOver={gameOver} handleFireworkPress={handleFireworkPress} handleButtonPress={handleButtonPress} />}
